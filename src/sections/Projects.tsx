  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <p className="text-center md:text-lg lg:text-xl text-white/60 mt-4 max-w-md mx-auto" >see how i transformed my ideas</p>
            ...
            <Card key={project.title} className=" p-8 pt-8 md:pt-12 md:px-10 lg:mt-16 lg:px-20 sticky"
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  ...
                  <a href={project.link}>
                    <button className="bg-white text-gray-950 h-12 w-full md:w-auto px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-0 mt-8">
                      <span>
                        View live site
                      </span>
